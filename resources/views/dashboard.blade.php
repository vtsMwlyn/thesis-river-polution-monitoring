...
@section('content')
    <div class="grid grid-cols-5 gap-x-8">
        <x-section-container class="flex flex-col items-center gap-2">
            <i class="bi bi-thermometer-low text-4xl"></i>
            <h1>Suhu</h1>
            <div class="text-xl font-semibold bg-slate-400 animate-pulse h-[25px] w-1/3"></div>
        </x-section-container>

        <x-section-container class="flex flex-col items-center gap-2">
            <i class="bi bi-reception-2 text-4xl"></i>
            <h1>Nilai pH</h1>
            <div class="text-xl font-semibold bg-slate-400 animate-pulse h-[25px] w-1/3"></div>
        </x-section-container>

        <x-section-container class="flex flex-col items-center gap-2">
            <i class="bi bi-droplet-half text-4xl"></i>
            <h1>Tingkat Kekeruhan</h1>
            <div class="text-xl font-semibold bg-slate-400 animate-pulse h-[25px] w-1/3"></div>
        </x-section-container>

        <x-section-container class="flex flex-col items-center gap-2">
            <i class="bi bi-ui-radios-grid text-4xl"></i>
            <h1>Padatan Terlarut</h1>
            <div class="text-xl font-semibold bg-slate-400 animate-pulse h-[25px] w-1/3"></div>
        </x-section-container>

        <x-section-container class="flex flex-col items-center gap-2">
            <i class="bi bi-trash2 text-4xl"></i>
